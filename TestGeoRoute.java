...
public class TestGeoRoute {
	...
	public void test_GeoRoute_comparable() {
		...
		GeoRoute billundRoute = new GeoRoute("Billund", new ArrayList<GeoPosition>(Arrays.asList(hamburg, billund)));
		GeoRoute amsterdamRoute = new GeoRoute("Amsterdam", new ArrayList<GeoPosition>(Arrays.asList(hamburg, amsterdam)));
		GeoRoute lyonRoute = new GeoRoute("Lyon", new ArrayList<GeoPosition>(Arrays.asList(hamburg, lyon)));
		...
		// Sort
		ArrayList<GeoRoute> routes = new ArrayList<GeoRoute>(Arrays.asList(lyonRoute, amsterdamRoute, billundRoute));
